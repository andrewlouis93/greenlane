	  ...
	  function addBike(_Actions, clickEvent) {
	    $('a').has('.svg-bike-switch').animate({
	      padding: '0px'
	    }, 200);
	    $('a').has('.svg-bike-switch').animate({
	      padding: "5%"
	    }, 200);
	    $('.cloudTwoBike').delay(400).animate({
	      left: "-15%",
	      opacity: '1'
	    }, 200);
	    $('.cloudOneBike').delay(400).animate({
	      right: "-10%",
	      opacity: '1'
	    }, 200).delay(200).promise().then(
	      function() {
	  ...
	  function addWalk(_Actions) {
	    $('a').has('.svg-walk-switch').animate({
	      padding: '0px'
	    }, 200);
	    $('a').has('.svg-walk-switch').animate({
	      padding: "5%"
	    }, 200);
	    $('.cloudTwoWalk').delay(400).animate({
	      left: "-15%",
	      opacity: '1'
	    }, 200);
	    $('.cloudOneWalk').delay(400).animate({
	      right: "-10%",
	      opacity: '1'
	    }, 200).delay(200).promise().then(
	      function() {
	  ...
	  function addRoute(_Actions) {
	    ...
	    setTimeout(function() {
	      ...
	      $('#locIconEnd').attr('class', 'bounceTwo')
	    }, 350);
	  ...
	  function addLoop(_Actions) {
	    ...
	    setTimeout(function() {
	      $('#locIconLoop').attr('class', 'bounceOne')
	    }, 350);
